...
float closest_to_zero(const int32_t &est_bias, const unsigned short &e_bits, const unsigned short &m_bits)
{
    u_int32_t sign = 0;
...
float delta(const int32_t &est_bias, const unsigned short &e_bits, const unsigned short &m_bits)
{
...
float max(const int32_t &est_bias, const unsigned short &e_bits, const unsigned short &m_bits)
{
    u_int32_t sign = 0;
    u_int32_t exp = po2_pow32(e_bits - 1) - 1 + ieee_bias + est_bias;
...
float min(const int32_t &est_bias,const unsigned short &e_bits, const unsigned short &m_bits)
{
    u_int32_t sign = 1;
    u_int32_t exp = -po2_pow32(e_bits - 1) + 1 + ieee_bias + est_bias;
    u_int32_t man = (1 << m_bits) - 1;
...
PYBIND11_MODULE(fpquantizer, m) {
    ...
    m.def("max", py::overload_cast<const int32_t &, const unsigned short&, const unsigned short&>(&max));
    m.def("max", py::overload_cast<const unsigned short&, const unsigned short&>(&max));
    m.def("min", py::overload_cast<const int32_t &, const unsigned short&, const unsigned short&>(&min));
    m.def("min", py::overload_cast<const unsigned short&, const unsigned short&>(&min));
    m.def("closest_to_zero", py::overload_cast<const int32_t &, const unsigned short&, const unsigned short&>(&closest_to_zero));
    m.def("closest_to_zero", py::overload_cast<const unsigned short&, const unsigned short&>(&closest_to_zero));
    m.def("delta", py::overload_cast<const int32_t &, const unsigned short&, const unsigned short&>(&delta));
