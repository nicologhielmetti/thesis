...
state_lstm_1_bias = activations_analysis['layer_data']['lstm_1_activation']['statistical_values']['bias']
...
state_lstm_1_exp = activations_analysis['layer_data']['lstm_1_activation']['statistical_values']['min_exp_bit']
...
state_lstm_1_man = activations_analysis['layer_data']['lstm_1_activation']['statistical_values']['min_man_bit'][4]
